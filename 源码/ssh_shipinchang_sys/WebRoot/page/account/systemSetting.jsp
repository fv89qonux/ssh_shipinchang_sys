...
<script src="${pageContext.request.contextPath}/page/account/js/systemSetting.js"></script>
<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/page/account/css/systemSetting.css"/>
