...
<html>
  ...
  <body>
	<div  style="height:100%;">
	  <ul id="navigation">
	    <li><a class="head">加工厂管理</a>
	      <ul>
	        <li><a href="goods/Goods_goodsIndex.action" target="rightFrame">商品种类</a></li>
	    ...
	    <li><a class="head">系统维护</a>
	      <ul>
	      	...
	      	<!-- <li><a href="page/account/systemSetting.jsp" target="rightFrame">系统设置</a></li> -->
	      </ul>
	    </li>
	  </ul>
	</div>
