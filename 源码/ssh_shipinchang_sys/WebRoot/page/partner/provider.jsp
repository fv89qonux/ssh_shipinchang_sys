...
<script src="${pageContext.request.contextPath}/page/partner/js/provider.js"></script>
<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/page/partner/css/provider.css"/>
