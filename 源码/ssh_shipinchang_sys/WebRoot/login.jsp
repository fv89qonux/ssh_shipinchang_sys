	...
	<div id="login">
				...
				<form action="account/Account_login.action" method="post" onsubmit="return validateLogin();">
					<div class="input_row">
						...
						<div class="input_row_rigth">
							<input type="text" id="username" name="account.userName" class="input_account" maxlength="20" value="" />
						</div>
					</div>
					<div class="input_row">
						<div class="input_row_left">密 码</div>
						<div class="input_row_rigth">
							<input type="password" id="password" name="account.password" class="input_account" maxlength="20" />
						</div>
					</div>
					...
					<div class="input_row">
						...
						<div class="input_vcode_rigth">
							<a href="javascript:changevcode();"><img id="img_vcode" alt="验证码" src="image.jsp" title="看不清,请点击" /></a>
						</div>
					</div>
		...
		<div id="down">
			<div id="down_left">
				...
				<span class="copyright">食品加工厂管理信息系统</span>
				</div>
			</div>
