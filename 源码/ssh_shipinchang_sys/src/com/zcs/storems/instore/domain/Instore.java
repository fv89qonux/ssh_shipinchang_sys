 ...
 */
@Entity
@Table(name = "TB_INSTORE", catalog = "ssh_shipinchang_sys")
public class Instore implements Serializable {
	...
	public String toString() {
		return "Instore [id=" + id + ", goodsId=" + goodsId + ", providerId=" + providerId + ", userId=" + userId
				+ ", inDate=" + inDate + ", price=" + price + ", amount=" + amount + ", note=" + note + ", goodsName="
				+ goodsName + ", providerName=" + providerName + ", userName=" + userName + "]";
	}
