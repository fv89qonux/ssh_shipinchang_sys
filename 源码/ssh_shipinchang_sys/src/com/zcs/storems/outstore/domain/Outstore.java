 ...
 */
@Entity
@Table(name = "TB_OUTSTORE", catalog = "ssh_shipinchang_sys")
public class Outstore implements Serializable {
	...
	public String toString() {
		return "Outstore [id=" + id + ", goodsId=" + goodsId + ", consumerId=" + consumerId + ", userId=" + userId
				+ ", outDate=" + outDate + ", price=" + price + ", amount=" + amount + ", note=" + note + ", goodsName="
				+ goodsName + ", consumerName=" + consumerName + ", userName=" + userName + "]";
	}
